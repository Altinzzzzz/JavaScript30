...
window.addEventListener('keydown', function(e){
    const elementet = document.querySelector(`button[data-key="${e.key}"]`);
...
for(var i = 0; i < numbers.length; i++){
    ...
    numbers[i].addEventListener('mouseover', function(){ this.style.border = '2px solid #ff3e1e'; });
    numbers[i].addEventListener('mouseout', function(){ this.style.border = '2px solid blue'; });
}
